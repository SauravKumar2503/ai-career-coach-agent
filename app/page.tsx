    ...
    <div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-end sm:ps-7 cursor-pointer">
              {!user ? (
                <SignInButton mode='modal' signUpForceRedirectUrl={'/dashboard'}>
                  <div className="flex items-center gap-x-2 font-medium text-gray-500 hover:text-blue-600 sm:border-s sm:border-gray-300 py-2 sm:py-0 sm:ms-4 sm:my-6 sm:ps-6 dark:border-neutral-700 dark:text-neutral-400 dark:hover:text-blue-500" >
                    <svg className="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
        ...
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
          <div className="mt-5 max-w-2xl text-center mx-auto">
            <h1 className="font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-neutral-200">
              Land Your Dream Job with the <span className="bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent">AI Career Coach</span>
            </h1>
          </div>
          ...
          <div className="mt-8 flex justify-center gap-3">
            <a href="/dashboard" className="inline-flex items-center gap-x-3 bg-gradient-to-tl from-blue-600 to-violet-600 hover:from-violet-600 hover:to-blue-600 text-white text-sm font-medium rounded-md py-3 px-4">
              Get Career Guidance
              <svg className="flex-shrink-0 size-4" viewBox="0 0 24 24"><path d="m9 18 6-6-6-6" /></svg>
            </a>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-2">
          {[
            { title: "AI Career Chat Q&A", desc: "Ask career-relatd questions and get instant AI guidance on jobs,skills and trends.", icon: "M14 9a2 2 0 0 1-2 2H6l-4 4V4..."},

            { title: "AI Resume Analyzer", desc: "Get real-time feedback and improvements for your resume using AI.", icon: "M2 3h6a4 4 0 0 1 4 4v14..." },

            { title: "AI Roadmap Generator", desc: "Receive a personalized career roadmap based on your goals and skills.", icon: "M20 7h-9 M14 17H5..." },

            { title: "AI Cover Letter Generator", desc: "Instantly create compelling and customized cover letters with AI.", icon: "M8 18h.01 M5 4a2 2..." }
            ...
            <a key={i} className="group flex flex-col justify-center hover:bg-gray-50 rounded-xl p-4 md:p-7 dark:hover:bg-neutral-800" href="#">
              <div className="flex justify-center items-center size-12 bg-blue-600 rounded-xl">
                <svg className="flex-shrink-0 size-6 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d={icon} /></svg>
              </div>
              <div className="mt-5">
                <h3 className="group-hover:text-gray-600 text-lg font-semibold text-gray-800 dark:text-white dark:group-hover:text-gray-400">{title}</h3>
                <p className="mt-1 text-gray-600 dark:text-neutral-400">{desc}</p>
                <span className="mt-2 inline-flex items-center gap-x-1.5 text-sm text-blue-600 decoration-2 group-hover:underline font-medium">
                  Learn more
                  <svg className="size-4" viewBox="0 0 24 24"><path d="m9 18 6-6-6-6" /></svg>
                </span>
              </div>
            </a>
          ))}
